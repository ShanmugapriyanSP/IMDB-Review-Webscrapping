...
SERIES_BOTTOM_URL = 'https://www.imdb.com/list/ls063837343/?sort=list_order,asc&st_dt=&mode=simple&page=1&ref_=ttls_vw_smp'
MOVIES_BOTTOM_URL = 'https://www.imdb.com/list/ls031780759/?sort=list_order,asc&st_dt=&mode=simple&page=1&ref_=ttls_vw_smp'
